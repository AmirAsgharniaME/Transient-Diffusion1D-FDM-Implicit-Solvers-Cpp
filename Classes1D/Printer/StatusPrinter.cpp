...
void StatusPrinter::Print_Mesh1D_Field1D(const Mesh1D& Mesh1D_Obj,const Field1D& Field1D_Obj) 
{
...
void StatusPrinter::PrintStepStatus(std::size_t Step ,double Residual ,SolutionParameters<double>& dt_Obj)
{
...
void StatusPrinter::PrintConvergenceStatus(std::size_t Step,double Residual,SolutionParameters<double>& dt_Obj)
{
const double Time =static_cast<double>(Step) * dt_Obj.GetValue();
std::cout << "\n"
          << "========================================\n"
